    ...
    <AdminLayout>
      ...
      <div className={`min-h-screen ${tk.page}`}>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          {sp.activeTab === 'sales' && (
            <SchoolSalesSection quotations={quotations} orders={orders} invoices={invoices} metrics={metrics} tk={tk} />
          )}
      ...
      <EnrollDripDialog open={enrollOpen} onOpenChange={setEnrollOpen} leads={leads} contacts={contacts} onDone={sp.reload} />
