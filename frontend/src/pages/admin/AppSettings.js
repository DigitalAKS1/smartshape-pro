...
import { Building2, Mail, MessageSquare, Save, Send, Eye, EyeOff, Upload, Image, X, Plus, Trash2, Edit2, Clock, MapPin, Navigation } from 'lucide-react';
import { officeSettings } from '../../lib/api';
...
const TABS = [
  ...
  { id: 'field',    label: 'Field Settings', icon: MapPin },
];
