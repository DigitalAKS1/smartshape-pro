...
export default function useLeadsCRM() {
  ...
  const [leadForm, setLeadForm] = useState({
    ...
    assigned_to: '', assigned_name: '', notes: '', expected_value: '', tag_ids: [], referred_by_contact_id: '', referral_reward_status: 'none',
  });
